...
F_PRELOAD   = 249.0   # preload force at installed length [N]
...
# Calibrated to INT_Spring_measurement.txt (398 data points):
#   Piecewise linear regression; kink positions from phase-line departure.
#   Phase 1 (lift 0   ->  4.05 mm): k = 34.70 N/mm  (pre-binding)
...
LIFT_KINK1   = 4.05
LIFT_KINK2   = 7.67
S_KINK1      = S_PRELOAD + LIFT_KINK1   # 11.167 mm (from free length)
S_KINK2      = S_PRELOAD + LIFT_KINK2   # 14.787 mm (from free length)
F_KINK1      = F_PRELOAD + 34.70 * LIFT_KINK1   # 389.5 N
F_KINK2      = F_KINK1   + 36.53 * (LIFT_KINK2 - LIFT_KINK1)  # 521.7 N

k_ana_phase1 = 34.70  # N/mm  (lift 0  -> 4.05 mm)
k_ana_phase2 = 36.53  # N/mm  (lift 4.05 -> 7.67 mm)
k_ana_phase3 = 40.90  # N/mm  (lift 7.67 -> 10.00 mm)
