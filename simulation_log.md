...
**Last updated:** 2026-06-13 08:15:10  
**Job status:** RUNNING
...
(SPRING_SURF,SPRING_SURF)
 ...
 LARGEST SCALED RESIDUAL FORCE      -1.76       AT NODE     132318   DOF  3
  CORRESPONDING RESIDUAL FORCE      -1.76    
 LARGEST INCREMENT OF DISP.         0.929       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.       -1.584E-02   AT NODE       1598   DOF  2
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        ...
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      7.775e+12
        SOLVER ELAPSED TIME:  43s

                  148 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                   76 POINTS CHANGED FROM OPEN TO CLOSED
                   72 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION    15

   MAX. PENETRATION ERROR 502.777E-03   AT NODE 94892 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -264.508E-03   AT NODE 24482 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.14       TIME AVG. FORCE        4.10    
 LARGEST SCALED RESIDUAL FORCE     -0.780       AT NODE      71782   DOF  3
  CORRESPONDING RESIDUAL FORCE     -0.780    
 LARGEST INCREMENT OF DISP.         0.938       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.       -1.468E-02   AT NODE      21080   DOF  2
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      7.684e+12
        SOLVER ELAPSED TIME:  42s

                  145 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                   86 POINTS CHANGED FROM OPEN TO CLOSED
                   59 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION    16

   MAX. PENETRATION ERROR 370.207E-03   AT NODE 94892 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -279.152E-03   AT NODE 129469 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.
