...
**Last updated:** 2026-06-13 15:31:38  
**Job status:** RUNNING

## Current Progress (.sta)
- Step 2, Increment 43, Attempt 1 — **converged**
- Total time: 17.8000  |  Increment size: 0.03007
- Converged increments so far: 59
...
ITERATION SUMMARY FOR THE INCREMENT:  11 TOTAL ITERATIONS, OF WHICH
 ...
 TIME INCREMENT COMPLETED  3.007E-02,  FRACTION OF STEP COMPLETED  0.989    
 STEP TIME COMPLETED        9.89    ,  TOTAL TIME COMPLETED         17.8    


  INCREMENT    44 STARTS. ATTEMPT NUMBER  1, TIME INCREMENT  3.007E-02
 
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      8.119e+12
        SOLVER ELAPSED TIME:  44s

                 1566 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                  881 POINTS CHANGED FROM OPEN TO CLOSED
                  685 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     1

   MAX. PENETRATION ERROR 902.494       AT NODE 130608 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 1.32738     AT NODE 32702 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       6.36       TIME AVG. FORCE        4.91    
 LARGEST SCALED RESIDUAL FORCE      -1.14       AT NODE     142396   DOF  3
  CORRESPONDING RESIDUAL FORCE      -1.14    
 LARGEST INCREMENT OF DISP.         0.360       AT NODE       1278   DOF  2
 LARGEST CORRECTION TO DISP.        2.706E-02   AT NODE       6636   DOF  1
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        ...
        SOLVER ELAPSED TIME:  42s
                  ...
                  357 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                  328 POINTS CHANGED FROM OPEN TO CLOSED
                   29 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     2

   MAX. PENETRATION ERROR 11.0748      AT NODE 78393 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 257.612E-03   AT NODE 32702 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       6.35       TIME AVG. FORCE        4.91    
 LARGEST SCALED RESIDUAL FORCE     -0.235       AT NODE     142397   DOF  3
  CORRESPONDING RESIDUAL FORCE     -0.235    
 LARGEST INCREMENT OF DISP.         0.352       AT NODE       1278   DOF  2
 LARGEST CORRECTION TO DISP.        1.395E-02   AT NODE       1547   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
   ...
   MAX. PENETRATION ERROR 6.71347     AT NODE 11044 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -246.198E-03   AT NODE 107874 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       6.34       TIME AVG. FORCE        4.91    
 LARGEST SCALED RESIDUAL FORCE       2.15       AT NODE     131598   DOF  3
  CORRESPONDING RESIDUAL FORCE       2.15    
 LARGEST INCREMENT OF DISP.         0.348       AT NODE       1278   DOF  2
 LARGEST CORRECTION TO DISP.        8.898E-03   AT NODE       1547   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
   ...
   MAX. PENETRATION ERROR 455.056E-03   AT NODE 27493 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 201.629E-03   AT NODE 149746 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       6.34       TIME AVG. FORCE        4.91    
 LARGEST SCALED RESIDUAL FORCE     -0.232       AT NODE     142745   DOF  3
  CORRESPONDING RESIDUAL FORCE     -0.232    
 LARGEST INCREMENT OF DISP.         0.345       AT NODE       1278   DOF  2
 LARGEST CORRECTION TO DISP.        5.845E-03   AT NODE       1547   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
