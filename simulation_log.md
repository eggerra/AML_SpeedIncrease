...
**Last updated:** 2026-06-13 08:37:52  
**Job status:** RUNNING
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        ...
        SOLVER ELAPSED TIME:  44s
               ...
               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION    36

   MAX. PENETRATION ERROR 730.516E-03   AT NODE 139254 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -321.329E-03   AT NODE 22276 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.19       TIME AVG. FORCE        4.11    
 LARGEST SCALED RESIDUAL FORCE     -0.728       AT NODE     131598   DOF  3
  CORRESPONDING RESIDUAL FORCE     -0.728    
 LARGEST INCREMENT OF DISP.         0.934       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.        1.818E-02   AT NODE       1274   DOF  2
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      7.545e+12
        SOLVER ELAPSED TIME:  41s

                   98 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                   50 POINTS CHANGED FROM OPEN TO CLOSED
                   48 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION    37

   MAX. PENETRATION ERROR 611.953E-03   AT NODE 17160 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -328.933E-03   AT NODE 22276 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.19       TIME AVG. FORCE        4.11    
 LARGEST SCALED RESIDUAL FORCE      0.650       AT NODE      71353   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.650    
 LARGEST INCREMENT OF DISP.         0.929       AT NODE       7078   DOF  1
