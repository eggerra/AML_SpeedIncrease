...
**Last updated:** 2026-06-13 08:58:08  
**Job status:** RUNNING

## Current Progress (.sta)
- Step 2, Increment 21, Attempt 2 — **converged**
- Total time: 17.0000  |  Increment size: 0.12500
...
AVERAGE FORCE                       4.87       TIME AVG. FORCE        4.09    
 LARGEST SCALED RESIDUAL FORCE      1.661E-02   AT NODE      11494   DOF  3
  CORRESPONDING RESIDUAL FORCE      1.661E-02
 LARGEST INCREMENT OF DISP.        -0.126       AT NODE       2584   DOF  3
 LARGEST CORRECTION TO DISP.        2.263E-04   AT NODE      12740   DOF  1
   ...
   MAX. PENETRATION ERROR 14.5441E-03  AT NODE 123929 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 3.67084E-03 AT NODE 27421 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.87       TIME AVG. FORCE        4.09    
 LARGEST SCALED RESIDUAL FORCE     -6.163E-03   AT NODE      10440   DOF  3
  CORRESPONDING RESIDUAL FORCE     -6.163E-03
 LARGEST INCREMENT OF DISP.        -0.126       AT NODE       2584   DOF  3
 LARGEST CORRECTION TO DISP.        1.456E-04   AT NODE       9745   DOF  1
          THE FORCE     EQUILIBRIUM EQUATIONS HAVE CONVERGED
   ...
   MAX. PENETRATION ERROR 1.89757E-03 AT NODE 123929 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 2.34785E-03 AT NODE 27421 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.87       TIME AVG. FORCE        4.09    
 LARGEST SCALED RESIDUAL FORCE      4.632E-03   AT NODE      99067   DOF  3
  CORRESPONDING RESIDUAL FORCE      4.632E-03
 LARGEST INCREMENT OF DISP.        -0.126       AT NODE       2584   DOF  3
 LARGEST CORRECTION TO DISP.        7.569E-05   AT NODE       9746   DOF  1
          THE FORCE     EQUILIBRIUM EQUATIONS HAVE CONVERGED
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      8.815e+12
        SOLVER ELAPSED TIME:  48s

               CONVERGENCE CHECKS FOR EQUILIBRIUM ITERATION     1

   MAX. PENETRATION ERROR 56.8389E-06  AT NODE 89711 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 1.30359E-03 AT NODE 27421 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          THE CONTACT CONSTRAINTS HAVE CONVERGED.

 AVERAGE FORCE                       4.87       TIME AVG. FORCE        4.09    
 LARGEST SCALED RESIDUAL FORCE      2.147E-03   AT NODE      63299   DOF  3
  CORRESPONDING RESIDUAL FORCE      2.147E-03
 LARGEST INCREMENT OF DISP.        -0.126       AT NODE       2584   DOF  3
 LARGEST CORRECTION TO DISP.        4.290E-05   AT NODE       9746   DOF  1
          THE FORCE     EQUILIBRIUM EQUATIONS HAVE CONVERGED

 ITERATION SUMMARY FOR THE INCREMENT:  12 TOTAL ITERATIONS, OF WHICH
  11 ARE SEVERE DISCONTINUITY ITERATIONS AND  1 ARE EQUILIBRIUM ITERATIONS.

 TIME INCREMENT COMPLETED  0.125    ,  FRACTION OF STEP COMPLETED  0.914    
 STEP TIME COMPLETED        9.14    ,  TOTAL TIME COMPLETED         17.0    


  INCREMENT    22 STARTS. ATTEMPT NUMBER  1, TIME INCREMENT  0.188    
 
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      7.634e+12
        SOLVER ELAPSED TIME:  42s

                 1275 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                 1205 POINTS CHANGED FROM OPEN TO CLOSED
                   70 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     1

   MAX. PENETRATION ERROR 2.73408E+06 AT NODE 25189 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 1.01630     AT NODE 139915 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.97       TIME AVG. FORCE        4.13    
 LARGEST SCALED RESIDUAL FORCE      -1.14       AT NODE      63290   DOF  3
  CORRESPONDING RESIDUAL FORCE      -1.14    
 LARGEST INCREMENT OF DISP.         0.202       AT NODE       1882   DOF  1
 LARGEST CORRECTION TO DISP.        3.789E-02   AT NODE       9640   DOF  1
