...
**Last updated:** 2026-06-13 08:48:01  
**Job status:** RUNNING
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        ...
        SOLVER ELAPSED TIME:  41s
                   ...
                   37 POINTS CHANGED FROM OPEN TO CLOSED
                   28 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     3

   MAX. PENETRATION ERROR 531.980E-03   AT NODE 132403 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 351.524E-03   AT NODE 27421 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.87       TIME AVG. FORCE        4.09    
 LARGEST SCALED RESIDUAL FORCE      0.639       AT NODE      76089   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.639    
 LARGEST INCREMENT OF DISP.        -0.126       AT NODE       2584   DOF  3
 LARGEST CORRECTION TO DISP.        6.165E-03   AT NODE       9637   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
   ...
   MAX. PENETRATION ERROR 460.263E-03   AT NODE 132403 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 189.400E-03   AT NODE 27421 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.87       TIME AVG. FORCE        4.09    
 LARGEST SCALED RESIDUAL FORCE      0.326       AT NODE      63299   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.326    
 LARGEST INCREMENT OF DISP.        -0.126       AT NODE       2584   DOF  3
 LARGEST CORRECTION TO DISP.        3.506E-03   AT NODE       9637   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
