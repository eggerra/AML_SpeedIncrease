...
**Last updated:** 2026-06-13 10:59:50  
**Job status:** RUNNING
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        ...
        SOLVER ELAPSED TIME:  47s
                  ...
                  108 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                   55 POINTS CHANGED FROM OPEN TO CLOSED
                   53 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     4

   MAX. PENETRATION ERROR 437.595E-03   AT NODE 123923 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -188.744E-03   AT NODE 129469 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.39       TIME AVG. FORCE        4.34    
 LARGEST SCALED RESIDUAL FORCE     -0.551       AT NODE      15038   DOF  3
  CORRESPONDING RESIDUAL FORCE     -0.551    
 LARGEST INCREMENT OF DISP.         0.337       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.       -9.067E-03   AT NODE       1325   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      8.436e+12
        SOLVER ELAPSED TIME:  45s

                   94 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
   ...
   MAX. PENETRATION ERROR 617.270       AT NODE 77533 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -166.576E-03   AT NODE 129469 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.39       TIME AVG. FORCE        4.34    
 LARGEST SCALED RESIDUAL FORCE      0.357       AT NODE     139795   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.357    
 LARGEST INCREMENT OF DISP.         0.342       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.       -7.852E-03   AT NODE       1324   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
```
