...
**Last updated:** 2026-06-13 06:56:27  
**Job status:** RUNNING
  ...
  INCREMENT    16 STARTS. ATTEMPT NUMBER  1, TIME INCREMENT  0.281    
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      5.317e+12
        SOLVER ELAPSED TIME:  30s

                 1336 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                 1336 POINTS CHANGED FROM OPEN TO CLOSED

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     1

   MAX. PENETRATION ERROR 730.819E+03   AT NODE 56413 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 179.387E-03   AT NODE 63305 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.70       TIME AVG. FORCE        3.86    
 LARGEST SCALED RESIDUAL FORCE      0.189       AT NODE      71361   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.189    
 LARGEST INCREMENT OF DISP.        -0.281       AT NODE       2582   DOF  3
 LARGEST CORRECTION TO DISP.        1.404E-02   AT NODE       2107   DOF  3
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      4.930e+12
        SOLVER ELAPSED TIME:  27s

                   66 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
   ...
   MAX. PENETRATION ERROR 472.926E-03   AT NODE 24306 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 25.0291E-03  AT NODE 63305 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.70       TIME AVG. FORCE        3.86    
 LARGEST SCALED RESIDUAL FORCE     -2.815E-02   AT NODE     138818   DOF  3
  CORRESPONDING RESIDUAL FORCE     -2.815E-02
 LARGEST INCREMENT OF DISP.        -0.281       AT NODE       2582   DOF  3
 LARGEST CORRECTION TO DISP.        6.417E-03   AT NODE       2128   DOF  3
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
