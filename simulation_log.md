...
**Last updated:** 2026-06-13 07:44:43  
**Job status:** RUNNING

## Current Progress (.sta)
- Step 2, Increment 19, Attempt 1 — **converged**
- Total time: 16.4000  |  Increment size: 0.50000
...
## Recent .msg output
```
MAX. CONTACT FORCE ERROR 1.82808     AT NODE 27421 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.84       TIME AVG. FORCE        4.05    
 LARGEST SCALED RESIDUAL FORCE       6.00       AT NODE      76393   DOF  3
  CORRESPONDING RESIDUAL FORCE       6.00    
 LARGEST INCREMENT OF DISP.        -0.503       AT NODE       2583   DOF  3
 LARGEST CORRECTION TO DISP.        7.600E-02   AT NODE       1881   DOF  1
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        ...
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      7.720e+12
        SOLVER ELAPSED TIME:  41s

                  118 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                   77 POINTS CHANGED FROM OPEN TO CLOSED
                   41 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     2

   MAX. PENETRATION ERROR 659.391E-03   AT NODE 27304 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 1.00256     AT NODE 27421 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.83       TIME AVG. FORCE        4.05    
 LARGEST SCALED RESIDUAL FORCE       3.36       AT NODE      76393   DOF  3
  CORRESPONDING RESIDUAL FORCE       3.36    
 LARGEST INCREMENT OF DISP.        -0.503       AT NODE      58175   DOF  3
 LARGEST CORRECTION TO DISP.        2.847E-02   AT NODE       7078   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      7.431e+12
        SOLVER ELAPSED TIME:  40s

                  149 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                   83 POINTS CHANGED FROM OPEN TO CLOSED
                   66 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     3

   MAX. PENETRATION ERROR 574.768E-03   AT NODE 8733 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 545.553E-03   AT NODE 27421 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.83       TIME AVG. FORCE        4.05    
 LARGEST SCALED RESIDUAL FORCE       1.39       AT NODE      76393   DOF  3
  CORRESPONDING RESIDUAL FORCE       1.39    
 LARGEST INCREMENT OF DISP.        -0.503       AT NODE      58175   DOF  3
 LARGEST CORRECTION TO DISP.        1.937E-02   AT NODE       7077   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
   ...
   MAX. PENETRATION ERROR 512.056E-03   AT NODE 27304 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 313.900E-03   AT NODE 27421 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.83       TIME AVG. FORCE        4.05    
 LARGEST SCALED RESIDUAL FORCE      0.743       AT NODE      76089   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.743    
 LARGEST INCREMENT OF DISP.        -0.503       AT NODE      58175   DOF  3
 LARGEST CORRECTION TO DISP.        1.055E-02   AT NODE       7077   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
   ...
   MAX. PENETRATION ERROR 357.052E-03   AT NODE 27304 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 347.213E-03   AT NODE 71362 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       4.83       TIME AVG. FORCE        4.05    
 LARGEST SCALED RESIDUAL FORCE      0.537       AT NODE      56411   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.537    
 LARGEST INCREMENT OF DISP.        -0.503       AT NODE      58175   DOF  3
 LARGEST CORRECTION TO DISP.        6.582E-03   AT NODE       7077   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
