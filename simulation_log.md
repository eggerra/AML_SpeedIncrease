...
**Last updated:** 2026-06-13 08:25:18  
**Job status:** RUNNING
...
## Recent .msg output
```
MAX. CONTACT FORCE ERROR 492.683E-03   AT NODE 27158 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.16       TIME AVG. FORCE        4.11    
 LARGEST SCALED RESIDUAL FORCE      0.641       AT NODE     121781   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.641    
 LARGEST INCREMENT OF DISP.         0.964       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.       -1.455E-02   AT NODE       6637   DOF  1
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        ...
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      8.245e+12
        SOLVER ELAPSED TIME:  45s

                  111 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                   58 POINTS CHANGED FROM OPEN TO CLOSED
                   53 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION    24

   MAX. PENETRATION ERROR 263.084E-03   AT NODE 16362 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 752.277E-03   AT NODE 27158 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.16       TIME AVG. FORCE        4.11    
 LARGEST SCALED RESIDUAL FORCE     -0.673       AT NODE     121779   DOF  3
  CORRESPONDING RESIDUAL FORCE     -0.673    
 LARGEST INCREMENT OF DISP.         0.964       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.        1.489E-02   AT NODE       1274   DOF  2
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        ...
        SOLVER ELAPSED TIME:  44s
               ...
               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION    25

   MAX. PENETRATION ERROR 277.446E-03   AT NODE 16362 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
