...
**Last updated:** 2026-06-13 13:29:49  
**Job status:** RUNNING
...
(SPRING_SURF,SPRING_SURF)
 ...
 AVERAGE FORCE                       5.99       TIME AVG. FORCE        4.61    
 LARGEST SCALED RESIDUAL FORCE     -0.485       AT NODE     156075   DOF  3
  CORRESPONDING RESIDUAL FORCE     -0.485    
 LARGEST INCREMENT OF DISP.        -0.443       AT NODE       6743   DOF  1
 LARGEST CORRECTION TO DISP.       -1.822E-02   AT NODE       9746   DOF  1
   ...
   MAX. PENETRATION ERROR 2.16476E+03 AT NODE 130980 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -203.692E-03   AT NODE 76384 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.99       TIME AVG. FORCE        4.61    
 LARGEST SCALED RESIDUAL FORCE     -0.411       AT NODE     156075   DOF  3
  CORRESPONDING RESIDUAL FORCE     -0.411    
 LARGEST INCREMENT OF DISP.        -0.454       AT NODE       6743   DOF  1
 LARGEST CORRECTION TO DISP.       -1.338E-02   AT NODE       9746   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
   ...
   MAX. PENETRATION ERROR 931.280       AT NODE 11161 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -234.651E-03   AT NODE 135203 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.99       TIME AVG. FORCE        4.61    
 LARGEST SCALED RESIDUAL FORCE      0.406       AT NODE     135203   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.406    
 LARGEST INCREMENT OF DISP.        -0.464       AT NODE       6743   DOF  1
 LARGEST CORRECTION TO DISP.        1.021E-02   AT NODE       1275   DOF  2
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      8.059e+12
        SOLVER ELAPSED TIME:  43s

                   56 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                   41 POINTS CHANGED FROM OPEN TO CLOSED
                   15 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     6

   MAX. PENETRATION ERROR 547.893       AT NODE 78750 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 293.859E-03   AT NODE 111613 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.98       TIME AVG. FORCE        4.61    
 LARGEST SCALED RESIDUAL FORCE     -0.286       AT NODE     156075   DOF  3
  CORRESPONDING RESIDUAL FORCE     -0.286    
 LARGEST INCREMENT OF DISP.        -0.471       AT NODE       6743   DOF  1
 LARGEST CORRECTION TO DISP.        8.085E-03   AT NODE       1275   DOF  2
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      7.877e+12
        SOLVER ELAPSED TIME:  43s

                   53 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
   ...
   MAX. PENETRATION ERROR 594.594       AT NODE 130988 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 265.570E-03   AT NODE 111613 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.98       TIME AVG. FORCE        4.61    
 LARGEST SCALED RESIDUAL FORCE     -0.268       AT NODE     156075   DOF  3
  CORRESPONDING RESIDUAL FORCE     -0.268    
 LARGEST INCREMENT OF DISP.        -0.477       AT NODE       6743   DOF  1
 LARGEST CORRECTION TO DISP.        6.725E-03   AT NODE       1275   DOF  2
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
