...
**Last updated:** 2026-06-13 10:06:47  
**Job status:** RUNNING
...
## Recent .msg output
```
MAX. CONTACT FORCE ERROR 793.406E-03   AT NODE 139796 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.29       TIME AVG. FORCE        4.27    
 LARGEST SCALED RESIDUAL FORCE      -1.13       AT NODE     141253   DOF  3
  CORRESPONDING RESIDUAL FORCE      -1.13    
 LARGEST INCREMENT OF DISP.         0.428       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.        4.596E-02   AT NODE      12738   DOF  1
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        ...
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      7.489e+12
        SOLVER ELAPSED TIME:  41s

                  239 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                  119 POINTS CHANGED FROM OPEN TO CLOSED
                  120 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     3

   MAX. PENETRATION ERROR 1.15073     AT NODE 138149 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 494.164E-03   AT NODE 18218 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.30       TIME AVG. FORCE        4.28    
 LARGEST SCALED RESIDUAL FORCE      0.858       AT NODE     139796   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.858    
 LARGEST INCREMENT OF DISP.         0.459       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.        3.635E-02   AT NODE      12740   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        ...
        SOLVER ELAPSED TIME:  42s
                  ...
                  144 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     4

   MAX. PENETRATION ERROR 569.538E-03   AT NODE 138821 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
