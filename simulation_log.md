...
**Last updated:** 2026-06-13 10:57:32  
**Job status:** RUNNING
...
## Recent .msg output
```
LARGEST SCALED RESIDUAL FORCE      5.606E-02   AT NODE      15038   DOF  3
  CORRESPONDING RESIDUAL FORCE      5.606E-02
 LARGEST INCREMENT OF DISP.         0.196       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.       -2.626E-04   AT NODE       6638   DOF  1
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        ...
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      8.292e+12
        SOLVER ELAPSED TIME:  45s

               CONVERGENCE CHECKS FOR EQUILIBRIUM ITERATION     1

   MAX. PENETRATION ERROR 652.436E-06   AT NODE 140055 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -3.74962E-03 AT NODE 24482 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          THE CONTACT CONSTRAINTS HAVE CONVERGED.

 AVERAGE FORCE                       5.23       TIME AVG. FORCE        4.30    
 LARGEST SCALED RESIDUAL FORCE      9.345E-03   AT NODE     129467   DOF  3
  CORRESPONDING RESIDUAL FORCE      9.345E-03
 LARGEST INCREMENT OF DISP.         0.196       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.       -2.008E-04   AT NODE       6638   DOF  1
          THE FORCE     EQUILIBRIUM EQUATIONS HAVE CONVERGED

 ITERATION SUMMARY FOR THE INCREMENT:  13 TOTAL ITERATIONS, OF WHICH
  12 ARE SEVERE DISCONTINUITY ITERATIONS AND  1 ARE EQUILIBRIUM ITERATIONS.

 TIME INCREMENT COMPLETED  5.933E-02,  FRACTION OF STEP COMPLETED  0.953    
 STEP TIME COMPLETED        9.53    ,  TOTAL TIME COMPLETED         17.4    


  INCREMENT    28 STARTS. ATTEMPT NUMBER  1, TIME INCREMENT  8.899E-02
 
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      8.233e+12
        SOLVER ELAPSED TIME:  48s

                 1571 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                 1008 POINTS CHANGED FROM OPEN TO CLOSED
                  563 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     1

   MAX. PENETRATION ERROR 606.778E-03   AT NODE 105696 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR 858.405E-03   AT NODE 818 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.39       TIME AVG. FORCE        4.34    
 LARGEST SCALED RESIDUAL FORCE       1.28       AT NODE        818   DOF  3
  CORRESPONDING RESIDUAL FORCE       1.28    
 LARGEST INCREMENT OF DISP.         0.303       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.        2.902E-02   AT NODE       9746   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      8.083e+12
        SOLVER ELAPSED TIME:  45s

                  416 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                  353 POINTS CHANGED FROM OPEN TO CLOSED
                   63 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     2

   MAX. PENETRATION ERROR 597.306E-03   AT NODE 105696 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -227.842E-03   AT NODE 24482 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.39       TIME AVG. FORCE        4.34    
 LARGEST SCALED RESIDUAL FORCE      0.548       AT NODE     139795   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.548    
 LARGEST INCREMENT OF DISP.         0.318       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.        1.541E-02   AT NODE       7078   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
	...
	SYMMETRIC PURE THREAD-BASED DIRECT SPARSE SOLVER RUNNING ON
 	1 HOST x 1 MPI RANK PER HOST x 4 THREADS PER RANK
        NUMBER OF EQUATIONS:  1146282
        NUMBER OF RHS:        1
        NUMBER OF FLOPS:      8.270e+12
        SOLVER ELAPSED TIME:  45s

                  132 SEVERE DISCONTINUITIES OCCURRED DURING THIS ITERATION.
                   64 POINTS CHANGED FROM OPEN TO CLOSED
                   68 POINTS CHANGED FROM CLOSED TO OPEN

               CONVERGENCE CHECKS FOR SEVERE DISCONTINUITY ITERATION     3

   MAX. PENETRATION ERROR 83.5431      AT NODE 79430 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
   MAX. CONTACT FORCE ERROR -207.461E-03   AT NODE 129469 OF CONTACT PAIR 
   (SPRING_SURF,SPRING_SURF)
          PENETRATION ERROR TOO LARGE COMPARED TO DISPLACEMENT INCREMENT.

 AVERAGE FORCE                       5.39       TIME AVG. FORCE        4.34    
 LARGEST SCALED RESIDUAL FORCE      0.482       AT NODE     139795   DOF  3
  CORRESPONDING RESIDUAL FORCE      0.482    
 LARGEST INCREMENT OF DISP.         0.329       AT NODE       7078   DOF  1
 LARGEST CORRECTION TO DISP.        1.076E-02   AT NODE       7078   DOF  1
          FORCE     EQUILIBRIUM NOT ACHIEVED WITHIN TOLERANCE.
